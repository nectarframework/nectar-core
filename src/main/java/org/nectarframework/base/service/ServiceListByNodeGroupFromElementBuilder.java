...
public class ServiceListByNodeGroupFromElementBuilder {

	public static HashMap<String, LinkedList<Service>> parseFullConfig(Element configElm) throws ConfigurationException {
